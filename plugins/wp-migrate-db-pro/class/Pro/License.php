...
class License
{
	...
	function ajax_check_licence()
	{
		...
		$licence          = '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx';
	...
	function ajax_activate_licence()
	{
		...
		$args = array(
			'licence_key' => urlencode( '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx' ),
		...
		$this->set_licence_key( '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx' );
		$decoded_response['masked_licence'] = $this->util->mask_licence( '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx' );
	...
	{
		return '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx';
	}
	...
	{
		update_user_meta( get_current_user_id(), Helpers::USER_LICENCE_META_KEY, '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx' );
	}
	...
	public function set_global_licence_key( $key ) {
		$this->settings['licence'] = '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx';
	...
	{
		return json_decode( $this->check_licence( '4uyrhge4u6sdhxgs6uyhxe5yhdsrjhrx' ), true );
		$licence = $this->get_licence_key();
